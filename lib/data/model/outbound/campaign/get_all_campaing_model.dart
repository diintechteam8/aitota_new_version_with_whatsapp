class GetAllOutboundCampaignsModel {
  bool? success;
  List<CampaignData>? data;

  GetAllOutboundCampaignsModel({this.success, this.data});

  GetAllOutboundCampaignsModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      data = List<CampaignData>.from(
        json['data'].map((v) => CampaignData.fromJson(v)),
      );
    }
  }
