class GetInboundBusinessInfoModel {
  final bool? success;
  final BusinessInfoData? data;

  GetInboundBusinessInfoModel({this.success, this.data});

  factory GetInboundBusinessInfoModel.fromJson(Map<String, dynamic> json) {
    return GetInboundBusinessInfoModel(
