...
class InboundConversationsController extends GetxController {
  final ApiService apiService = ApiService(dio: DioClient().dio);
  final conversations = <InboundConversationData>[].obs;
  ...
  InboundConversationModel? inboundConversationModel;
  ...
  Future<void> fetchConversations({
    ...
    try {
      ...
      final response = await apiService.getInboundConversations(
        filter: filter,
        startDate: startDate,
        endDate: endDate,
        page: currentPage.value,
      );
      inboundConversationModel = response;
