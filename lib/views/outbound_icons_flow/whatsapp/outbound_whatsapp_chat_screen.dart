...
import 'package:aitota_business/views/outbound_icons_flow/whatsapp/controller/outbound_whatsapp_chat_controller.dart';

class OutboundWhatsappChatScreen extends StatelessWidget {
  const OutboundWhatsappChatScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<OutboundWhatsappChatController>(
      global: false,
      init: OutboundWhatsappChatController(),
      builder: (controller) {
        return Scaffold(
